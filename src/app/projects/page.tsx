...
const ProjectsPage = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      bgGradient: "from-blue-500 to-blue-600",
      description:
        "Developed a market simulator with order matching algorithms and real-time data visualisation. Implemented WebSocket streaming for live order book updates.",
      achievements: [
        "Engineered order matching algorithms",
        "Real-time data visualisation with WebSocket streaming",
        "Responsive frontend interface for live order book updates",
      ...
      duration: "Sep 2025",
      impact: "Full-stack application demonstrating high-frequency financial data processing",
    },
    {
      id: "home-automation",
      ...
      description:
        "Self-hosted home server ecosystem running on Raspberry Pi 5 and custom GPU server, featuring remote control, monitoring, and machine learning capabilities.",
      achievements: [
        "Deployed **17+ Docker-containerised microservices** with automated backups",
        "Built **42GB VRAM GPU** home server for ML training and inference",
        "Devised home **weather monitoring IoT** with real-time data collection",
        "Implemented automated interactive dashboards and email notifications",
        "32TB NAS with facial recognition and secure VPN access",
      ],
      technologies: [
        "Raspberry Pi",
        "Docker",
      ...
      duration: "Ongoing",
      impact: "Enterprise-grade self-hosted infrastructure for AI and automation",
      links: [
        {
          type: "github",
