...
export const metadata = {
  ...
  description:
    "Step inside my rain-soaked Running Hackathon relay: 44 team kilometres, a runner-only build rule, the people behind the track and second-place app SideQuest.",
};
