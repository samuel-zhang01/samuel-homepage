...
const skillsData: SkillCard[] = [
  ...
  },
  {
    ...
    description:
      "Specialized in AI/ML applications with focus on computational modeling, predictive analytics, and real-world business implementation.",
    keyStrengths: [
    ...
    experience:
      "Currently pursuing MSc AI Applications at Imperial College London, with practical experience from research and industry projects",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Digital transformation expertise combining technical implementation with strategic business consulting to modernize legacy systems.",
    keyStrengths: [
    ...
    experience:
      "Led digital transformation initiatives at Pfizer and Singapore Civil Defence Force, impacting 1000+ users",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Pharmaceutical analytical chemistry experience with focus on computational method development, drug discovery, and quality assurance in regulated environments (GMP).",
    keyStrengths: [
    ...
    experience:
      "1st Class Honours Chemistry degree with industry placement at Pfizer Analytical R&D, plus research fellowships",
    achievements: [
    ...
    projects: [
      ...
      "Protein-Lipid Co-Assembly Research",
      "Odorant-Receptor Interaction Studies",
    ],
  },
  {
    id: "finance",
