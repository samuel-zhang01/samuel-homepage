...
const skillsData: SkillCard[] = [
  ...
  },
  {
    ...
    description:
      "Financial analysis, venture building, and data-driven insights with experience in resource planning, budgeting, and ROI optimization for technical projects.",
    keyStrengths: [
    ...
    experience:
      "Founder of AI recruitment startup, financial oversight of technical projects, and resource management for large teams.",
    achievements: [
      "Founded pre-seed phase AI venture startup in recruitment",
      "Currently sourcing Imperial VC funding rounds",
