...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: "Shipped",
    featured: true,
    eyebrow: "CONNECTED ACCOUNTS, A CLEARER FINANCIAL PICTURE",
    summary: "A personal finance workspace for net worth, connected bank accounts, two trading platforms and recurring-payment checks.",
    detail: "Ledger brings Lunch Flow bank feeds and read-only SnapTrade investment connections together with retained PDF and CSV statement history. Net worth combines bank balances, broker cash, holdings and credit debt without counting connected and imported accounts twice. Spending, transaction review, recurring-payment checks and planning turn that account history into useful decisions. The ocean-themed demo showcases five bank and credit accounts and two trading platforms, Trading 212 and Moomoo, using fictional balances and transactions. Toggle accounts in net worth, inspect investment values, find price changes in regular bills or explore the import and transfer checks.",
    tools: ["FastAPI", "React", "SQLite", "Statement parsers", "Reconciliation", "Transfer matching"],
    highlights: ["Net worth across five bank and credit accounts","Two trading platforms: Trading 212 and Moomoo","Recurring bills, price changes and spending review","Fictional data with interactive account and investment filters"],
    phases: phases(
