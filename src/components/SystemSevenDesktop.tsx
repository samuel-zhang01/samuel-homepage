...
function LabApp({ locale }: { locale: Locale }) {
  ...
  const services = [
    ...
    { group: "Operations", code: "CI", name: "GitHub Actions Runner", host: "Self-hosted CI", description: "Runs CI jobs on Samuel’s hardware across different CPU architectures." },
...
function AppContent({
  ...
  switch (id) {
    ...
    case "project": return initialProjectSlug ? <ProjectDocument key={initialProjectSlug} slug={initialProjectSlug} locale={locale} initialDemo={initialProjectDemo} active={active} onOpenApp={openApp} onBack={onProjectBack} onGraph={onProjectGraph} /> : null;
