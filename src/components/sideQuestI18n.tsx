...
const zhCN: Record<string, string> = {
  ...
  "I finished a RunThrough 5K in Regent’s Park with Axel Ehrnrooth, Yasmin Akhmedova and Thiruvikraman Anand, then crossed London for a second start line.": "我与 Axel Ehrnrooth、Yasmin Akhmedova 和 Thiruvikraman Anand 在摄政公园完成 RunThrough 5 公里赛后，又穿过伦敦赶赴第二条起跑线。",
  ...
  "Ideas, context and sore legs changed hands. Javiera Rubio, Andrés Daniel Godoy Ortiz and I kept SideQuest moving through phone dictation and repeated handovers.": "想法、上下文和酸痛的双腿在接力中轮番交接。Javiera Rubio、Andrés Daniel Godoy Ortiz 和我靠手机口述和一次次换棒，让 SideQuest 持续前进。",
  ...
  "Javiera Rubio, Andrés Daniel Godoy Ortiz and I relayed both the running and the product context. The build only progressed while one of us was moving.": "Javiera Rubio、Andrés Daniel Godoy Ortiz 和我同时接力跑步与产品上下文。只有当我们其中一人在移动时，开发才能继续。",
  "Event makers": "活动组织者",
  ...
  "A loud DJ, constant laps, soaked clothes, founders swapping ideas and an unusually high concentration of people willing to try something unreasonable. I left with more energy than I arrived with; my legs reported a different result.": "响亮的 DJ、不断重复的跑圈、湿透的衣服、交换想法的创始人，以及密集得不寻常的一群愿意尝试不合理之事的人。我离开时比抵达时更有精神；我的双腿对此有不同意见。",
  "Backers": "支持伙伴",
  ...
  "*The Devin award is reported in my event post; it is not listed in the official prize table preserved in the source pack.": "*Devin 奖励来自我的活动帖文；源资料包保存的官方奖项表并未列出此项。",
  "Event backers & community ledger": "活动支持伙伴与社区名录",
  ...
  "These documented counts belong to Javi's owner-scoped export—not my running history. Coverage describes available evidence; it is not a health or fitness score.": "这些已记录的数量来自 Javi 仅限所有者访问的导出数据，并非我的跑步历史。覆盖率只描述可用证据，不代表健康或体能评分。",
  ...
  "After a morning 5K, I joined Javiera Rubio and Andrés Daniel Godoy Ortiz at an event billed as Europe's first running hackathon. Only the teammate on the track could direct the build. Through rain, phone dictation and 44 additional team kilometres, we shipped SideQuest.": "早晨跑完 5 公里后，我与 Javiera Rubio、Andrés Daniel Godoy Ortiz 会合，参加这场号称欧洲首届的跑步黑客松。只有跑道上的队员能指挥开发。我们在雨中用手机口述，团队又跑了 44 公里，最终做出 SideQuest。",
