...
export const projectStories: Record<ProjectDemoId, ProjectStory> = {
  ...
  "cv-keywords": {
    ...
    contribution: "I built a Python workflow that extracts role language, selects a pre-authored CV template and compiles it with LaTeX. The browser companion adds an explicit review of whether the example CV supports each suggested change.",
...
export const projectCaseStudies: Record<string, ProjectStory> = {
  ...
  "coverd-ai": {
    ...
    contribution: "I founded and led the product, evolving company-aware voice interviews into an ATS-connected recruitment-intelligence layer.",
