...
export const projectNarrativeCopy = {
  ...
  "Browse all 118 elements and explore their electron configurations through real angular orbital components. Phase colours show the wavefunction sign, while point clouds sample probability density. Radial plots and central slices connect the 3D shapes to the mathematics. The hydrogen-like model is educational; it does not calculate a full many-electron atom.": [
    ...
    "瀏覽全部 118 種元素，透過實角向軌道分量探索電子排布。相位顏色表示波函數的正負號，點雲則按概率密度取樣。徑向曲線和中心切片把三維形狀與數學聯繫起來。這是用於教學的類氫原子模型，不計算完整的多電子原子。"
  ],
  "TypeScript": [
    "TypeScript",
    "TypeScript"
  ...
  "Samuel built a Python workflow that extracts job requirements, selects a pre-authored CV template and compiles a PDF with LaTeX. The browser demo uses fictional text to show which suggested changes the sample CV supports.": ["Samuel 开发了 Python 工作流，提取岗位要求、选择预先编写的简历模板，并用 LaTeX 编译 PDF。浏览器演示使用虚构文本，展示示例简历支持哪些修改建议。", "Samuel 開發了 Python 工作流程，擷取職位要求、選擇預先編寫的履歷範本，並用 LaTeX 編譯 PDF。瀏覽器示範使用虛構文字，展示範例履歷支持哪些修改建議。"],
  "Python": [
    "Python",
    "Python"
  ],
  ...
  "Samuel founded COVERD and led work on application review and company-aware voice interviews within recruiters’ existing applicant tracking systems.": ["Samuel 创立 COVERD，并带领团队在招聘人员现有的申请人追踪系统中开发申请审查和结合公司背景的语音面试。", "Samuel 創立 COVERD，並帶領團隊在招募人員現有的應徵者追蹤系統中開發申請審查及結合公司背景的語音面試。"],
