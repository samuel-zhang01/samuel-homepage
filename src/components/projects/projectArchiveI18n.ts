...
const enGB: ProjectArchiveCopy = {
  ...
  views: {
    ...
    guided: "Highlights",
    guidedHint: "Latest story · selected interactive work",
    files: "All {count} Projects",
    filesHint: "Search and inspect the complete archive",
    map: "How They Connect",
    mapHint: "Relationships between work, tools and evidence",
  },
  guided: {
    heroEyebrow: "SAMUEL HD / PROJECTS / HIGHLIGHTS",
    heroTitle: "A guided tour of selected work",
    ...
    startTitle: "Choose a project through a question",
    startDescription: "Four stand-out interactive walkthroughs. Each question opens a self-contained project.",
    ...
    startPaths: {
      ...
      microrobot: {
        ...
        description: "Inspect the image-to-pose pipeline, depth cues and the evidence boundary around a research prototype.",
      },
      molecular: {
...
const zhCN: ProjectArchiveCopy = {
  ...
  views: {
    aria: "项目档案视图",
    guided: "精选",
    guidedHint: "最新故事 · 精选互动项目",
    files: "全部 {count} 个项目",
    filesHint: "搜索并查看完整项目档案",
    map: "项目如何关联",
    mapHint: "工作、工具与证据之间的关系",
  },
  guided: {
    heroEyebrow: "SAMUEL HD / 项目 / 精选",
    heroTitle: "精选项目导览",
    heroDescription: "阅读最新现场记录，体验一个代表性互动项目，或按待解决的问题浏览完整档案。",
    statsAria: "引导式项目档案概览",
    experiencesStat: "引导式体验",
    suitesStat: "策展专题",
    filesStat: "证据档案",
    startEyebrow: "精选项目 · 建议从这里开始",
    startTitle: "通过一个问题选择项目",
    startDescription: "四个代表性互动导览；每个问题都将打开一个独立项目。",
    ...
    startPaths: {
      ...
      microrobot: {
        ...
        description: "查看从图像到姿态的流程、深度线索，以及研究原型的证据边界。",
      },
      molecular: {
        eyebrow: "分子研究",
        title: "合成光谱能否识别正确构象？",
...
const zhTW: ProjectArchiveCopy = {
  ...
  views: {
    aria: "專案檔案檢視",
    guided: "精選",
    guidedHint: "最新故事 · 精選互動專案",
    files: "全部 {count} 個專案",
    filesHint: "搜尋並查看完整專案檔案",
    map: "專案如何連結",
    mapHint: "工作、工具與證據之間的關係",
  },
  guided: {
    heroEyebrow: "SAMUEL HD / 專案 / 精選",
    heroTitle: "精選專案導覽",
    heroDescription: "閱讀最新現場記錄，體驗一個代表性互動專案，或依待解決的問題瀏覽完整檔案。",
    statsAria: "引導式專案檔案概覽",
    ...
    startPaths: {
      ...
      microrobot: {
        ...
        description: "查看從影像到姿態的流程、深度線索，以及研究原型的證據邊界。",
      },
      molecular: {
        eyebrow: "分子研究",
        title: "合成光譜能否識別正確構形？",
