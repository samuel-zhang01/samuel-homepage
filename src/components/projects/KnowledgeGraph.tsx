...
const graphTranslations: Record<string, string> = {
  ...
  "Topics": "主题", "Projects": "项目", "Methods": "方法", "Selected node": "已选节点", "Open live demo": "打开互动演示", "Read project": "阅读项目", "About this project": "项目详情", "Open education record": "打开教育记录", "Open experience record": "打开经历记录",
...
const traditionalGraphTranslations: Record<string, string> = {
  ...
  "Topics": "主題", "Projects": "專案", "Methods": "方法", "Selected node": "已選節點", "Open live demo": "開啟互動示範", "Read project": "閱讀專案", "About this project": "專案詳情", "Open education record": "開啟教育記錄", "Open experience record": "開啟經歷記錄",
