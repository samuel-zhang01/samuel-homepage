...
Later local work restored the split-pane browser, added generated icons and deeper grey layers, and repeated the four-language crawl. See the [latest refinement review](SYSTEM7_REFINEMENT_2026-09-09.md) for current screenshots, checks and output sizes. The record below describes the earlier redesign and cleanup checkpoint.
